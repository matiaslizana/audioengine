...
int main()
{
	...
	std::shared_ptr<SpriteRenderer> weaponSpriteRenderer = weaponGameObject->AddComponent<SpriteRenderer>();
    weaponSpriteRenderer->SetTexture("resources/assets.png", sf::IntRect(152, 102, 13, 8));
	std::shared_ptr<Weapon> weaponGameScript = weaponGameObject->AddComponent<Weapon>();
